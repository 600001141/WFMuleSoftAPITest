...
Given url 'https://mule-wft.qa.medpro.com/api/fileprocesses/prc/v1/<status id>'
When method get
Then status 200
...
Examples: 
      | read('file:src\\test\\java\\wfSImuleSoft\\wfSImuleSoft.testData\\ProcApiData\\data_getFileProcessStatusIDCSR3537.csv') |